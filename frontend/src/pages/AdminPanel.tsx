...
import { Trash2, LogIn, RefreshCw, ShieldAlert } from "lucide-react";
import { toast } from "sonner";
import { Status, DeleteIncidentResult } from "../backend";
...
export function AdminPanel() {
  ...
  const resolvedIncidents = allIncidents.filter(
    (inc) => inc.status === Status.resolved
  );
              ...
              {resolvedIncidents.map((inc) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{inc.affectedService}</p>
                  </div>
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Are you sure you want to delete &ldquo;{inc.title}&rdquo;? This action
                          cannot be undone.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
