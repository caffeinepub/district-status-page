...
const severityConfig: Record<Severity, { label: string; className: string; dotClass: string }> = {
  [Severity.critical]: {
    label: 'Critical',
    className: 'bg-[oklch(0.62_0.22_25/0.2)] text-[oklch(0.85_0.18_25)] border-[oklch(0.62_0.22_25/0.5)]',
    dotClass: 'bg-[oklch(0.62_0.22_25)] animate-pulse',
  },
  [Severity.major]: {
    label: 'Major',
    className: 'bg-[oklch(0.68_0.18_55/0.2)] text-[oklch(0.88_0.14_55)] border-[oklch(0.68_0.18_55/0.5)]',
    dotClass: 'bg-[oklch(0.68_0.18_55)]',
  },
  [Severity.minor]: {
    label: 'Minor',
    className: 'bg-[oklch(0.78_0.16_85/0.15)] text-[oklch(0.88_0.12_85)] border-[oklch(0.78_0.16_85/0.4)]',
    dotClass: 'bg-[oklch(0.78_0.16_85)]',
  },
  [Severity.informational]: {
    label: 'Info',
    className: 'bg-[oklch(0.62_0.16_220/0.15)] text-[oklch(0.78_0.14_220)] border-[oklch(0.62_0.16_220/0.4)]',
